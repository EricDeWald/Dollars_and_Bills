        ...
        <Navbar >
          <Container>
            ...
            <Navbar.Collapse className="justify-content-end">
              ...
              <Button href="/" onMouseEnter={()=>setHoverLogOut(true)} onMouseLeave={()=>setHoverLogOut(false)} style={ hoverLogOut ? { border: "solid #DF20BA 2px", backgroundColor: "#DF20BA", color:"black" }:{ border: "solid #DF20BA 2px", backgroundColor: "black", color: "#DFA420"}}>
